...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'bf', isPlayer:Bool = false)
	{
		...
		animation.add('bf-car', [0, 1, 28], 0, false, isPlayer);
		animation.add('bf-christmas', [0, 1, 28], 0, false, isPlayer);
		...
		animation.add('gf', [16, 29, 16], 0, false, isPlayer);
		animation.add('gf-christmas', [16], 0, false, isPlayer);
		animation.add('gf-pixel', [16], 0, false, isPlayer);
		animation.add('parents-christmas', [17, 18], 0, false, isPlayer);
		animation.add('lucy', [24, 26, 26], 0, false, isPlayer);
		animation.add('monster', [19, 20, 19], 0, false, isPlayer);
		animation.add('monster-christmas', [19, 20, 19], 0, false, isPlayer);
		animation.add('bf-steam', [0, 1, 28], 0, false, isPlayer);
		animation.add('gf-steam', [16, 29, 16], 0, false, isPlayer);
		animation.play(char);
